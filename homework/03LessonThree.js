...
// Your Answer Goes Here:
//
// A ternary operator accepts 3 operands, if the first operand evaluates as true it returns the value of the second operands, if its false, it returns the value of the third operand
//
//
